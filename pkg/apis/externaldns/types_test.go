...
var (
	...
	overriddenConfig = &Config{
		...
		LeaderElection:                         true,
		LeaderElectionIdentity:                 "my-identity",
		LeaderElectionNamespace:                "my-namespace",
		LeaderElectionLockName:                 "my-lock",
		LeaderElectionLeaseDuration:            20 * time.Second,
	...
	for _, ti := range []struct {
		...
		},
		{
			...
			args: []string{
				...
				"--request-timeout=77s",
				"--leader-election",
				"--leader-election-identity=my-identity",
		...
		},
		{
			...
			envVars: map[string]string{
				...
				"EXTERNAL_DNS_LEADER_ELECTION":                                   "1",
				"EXTERNAL_DNS_LEADER_ELECTION_IDENTITY":                          "my-identity",
				"EXTERNAL_DNS_LEADER_ELECTION_NAMESPACE":                         "my-namespace",
				"EXTERNAL_DNS_LEADER_ELECTION_LOCK_NAME":                         "my-lock",
				"EXTERNAL_DNS_LEADER_ELECTION_LEASE_DURATION":                    "20s",
				"EXTERNAL_DNS_LEADER_ELECTION_RENEW_DEADLINE":                    "15s",
				"EXTERNAL_DNS_LEADER_ELECTION_RETRY_PERIOD":                      "5s",
